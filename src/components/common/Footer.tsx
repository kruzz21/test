        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <div className="text-white font-bold text-lg leading-tight">Dr. Eryanılmaz</div>
                <div className="text-gray-400 text-xs">Orthopedic Specialist</div>
              </div>
            </div>
          ...
          <div>
            ...
            {/* Regional Clinics */}
            <div className="mt-6">
              <h4 className="text-lg font-semibold mb-3 text-gray-200">Regional Clinics</h4>
