/*
  # Calendar System Migration - Fixed
  ...
  2. Enhanced Functions
    ...
    - `get_calendar_data` - Get comprehensive calendar data for admin panel
    - `block_time_slots` - Block specific time ranges
    - `unblock_time_slots` - Remove blocked time ranges
    - `set_recurring_availability` - Set weekly availability patterns
    - `get_available_slots_enhanced` - Enhanced slot availability for users
