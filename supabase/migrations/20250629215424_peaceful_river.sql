/*
  ...
  1. New Tables
    - `calendar_slots` - Define recurring availability patterns
    - `blocked_slots` - Block specific time slots
    - Enhanced `appointments` table with better constraints

  2. Security
    - Enable RLS on all tables
    - Add policies for admin and public access
    - Secure functions for slot management

  3. Functions
    - Generate available slots based on calendar patterns
