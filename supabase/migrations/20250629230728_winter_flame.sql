/*
  # Fix Calendar RPC Function

  1. Functions
    - Create `is_admin()` function for admin role checking
    - Create `get_calendar_data_enhanced()` function for calendar data retrieval
  ...
  3. Changes
    - Fixed syntax error by avoiding reserved keyword 'time' as column name
    - Uses 'slot_time' instead of 'time' for the time column
*/
