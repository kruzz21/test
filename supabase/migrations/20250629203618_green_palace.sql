/*
  # Create authentication and audit functions

  1. New Functions
    - `log_audit_event` - Function to log audit events to audit_logs table
    - `authenticate_admin_secure` - Function to authenticate admin users securely
