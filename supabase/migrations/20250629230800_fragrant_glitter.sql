/*
  # Fix calendar data function migration

  1. Functions
    - Drop existing get_calendar_data_enhanced function if it exists
    - Create is_admin function for role checking
    - Create get_calendar_data_enhanced function with correct return type
